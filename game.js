...
const portedModes = {
  spaceball: { label: '太空棒球', bg: 'spaceball_bg_map.png', backdrop: '#121836', assetScale: 4, idle: 1, action: [1,2,3,4,5], actor: [190,105], object: 6, duration: { CUE_LOW_FAST:12, CUE_LOW:24, CUE_HIGH:48, CUE_HIGH_FAST:36 }, music: [['spaceball_bgm_events',75]], sfx: { spawn:'spaceball_throw_events', high:'spaceball_high_events', hit:'spaceball_hit_events', barely:'spaceball_barely_events', land:'spaceball_land_events' } },
...
const PORTED_ASSET_REV = 'gba-ports-hd-15';
