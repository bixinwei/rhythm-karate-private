...
ATLAS_MAP = {
    (248, 248, 248): (255, 255, 255),   # trim / balls        -> pure white
    ...
    (96, 224, 0):    (255, 92, 158),    # batter 1 outfit     -> hot sakura pink
    (0, 104, 16):    (206, 40, 108),    # batter 1 shade / plants -> deep pink-red
    (40, 56, 0):     (120, 26, 74),
    (48, 72, 0):     (146, 34, 88),
    ...
    (56, 96, 152):   (92, 116, 210),    # ufo body            -> periwinkle
    (24, 48, 80):    (46, 58, 128),
...
BG_MAP = {
    (0, 160, 24):  (66, 208, 122),    # turf stripes -> saturated mint-green
    (0, 144, 24):  (52, 190, 110),
    (0, 128, 16):  (40, 170, 98),
    (0, 104, 16):  (28, 146, 84),
    (0, 0, 112):   (74, 84, 216),     # night sky    -> vivid indigo
    (48, 72, 0):   (20, 118, 70),
